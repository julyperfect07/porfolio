...
export default function About() {
  return (
    <section id="about" aria-labelledby="about-heading" className="scroll-mt-8 border-t border-border">
      <div className="responsive-copy mx-auto grid max-w-5xl gap-8 px-6 py-20 sm:px-10 sm:py-24 md:grid-cols-[1fr_1.4fr] md:gap-16">
        ...
        <Reveal direction="right" delay={0.18} className="space-y-5 text-base leading-8 text-muted-foreground sm:text-lg">
